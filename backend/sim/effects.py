...
class SpecialName:
    ...
    POWER_BY_FAINTED = 'power_by_fainted'
    POWER_BY_MISSING_HP = 'power_by_missing_hp'
    POWER_PENALTY_BY_ENERGY = 'power_penalty_by_energy'
    ...
    ALL: frozenset[str] = frozenset({
        ...
        DISPEL_POSITIVE, DISPEL_NEGATIVE, DISPEL_MARK, STEAL_MARK,
        ...
        POWER_BY_ENEMY_ENERGY, POWER_BY_ADJACENT, POWER_BY_FAINTED, POWER_BY_MISSING_HP,
        POWER_PENALTY_BY_ENERGY,
