"""dbg_mcts37d - trace py resolve decisions for spec 0037 fixed-action step."""
...
sb = battle.player_b.active.skills[opp_idx]
print("skillA:", sa.name, "is_attack=", sa.is_attack, "counter=", sa.counter)
print("skillB:", sb.name, "is_attack=", sb.is_attack, "counter=", sb.counter)
